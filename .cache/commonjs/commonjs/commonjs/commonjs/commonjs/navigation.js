...
var _loadDirectlyOr = _interopRequireDefault(require("./load-directly-or-404")); // Convert to a map for faster lookup in maybeRedirect()
...
const navigate = (to, options = {}) => {
  ...
  let _ref = (0, _parsePath.default)(to),
