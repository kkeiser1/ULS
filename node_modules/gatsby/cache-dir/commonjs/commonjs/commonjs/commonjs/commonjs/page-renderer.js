...
var _apiRunnerBrowser = require("./api-runner-browser"); // Renders page
...
class PageRenderer extends _react.default.Component {
  render() {
    ...
    const _ref = (0, _apiRunnerBrowser.apiRunner)(`replaceComponentRenderer`, {
      props: this.props,
      loader: _loader.publicLoader
    }),
          replacementElement = _ref[0];
